...
Replace this section with the supported versions for `shellgarden`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `shellgarden` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in shellgarden.
